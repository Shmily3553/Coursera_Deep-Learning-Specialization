...
```
    ...
    <ipython-input-21-fb7a58b39ba9> in <module>()
          ...
          3 
    ----> 4 dA_prev, dW, db = linear_backward(dZ, linear_cache)
          5 print ("dA_prev = "+ str(dA_prev))
          6 print ("dW = " + str(dW))


    <ipython-input-20-3e32145f70fb> in linear_backward(dZ, cache)
...
```
    ...
    <ipython-input-19-3f1a403310df> in <module>()
          ...
          2 
    ----> 3 dA_prev, dW, db = linear_activation_backward(dAL, linear_activation_cache, activation = "sigmoid")
          4 print ("sigmoid:")
          5 print ("dA_prev = "+ str(dA_prev))


    <ipython-input-18-b1818dccebf9> in linear_activation_backward(dA, cache, activation)
    ...
    <ipython-input-16-3e32145f70fb> in linear_backward(dZ, cache)
         25     assert (dA_prev.shape == A_prev.shape)
         26     assert (dW.shape == W.shape)
    ---> 27     assert (db.shape == b.shape)
         28 
...
```
    ...
    <ipython-input-22-5cfa07ae3c38> in L_model_backward(AL, Y, caches)
         31     ### START CODE HERE ### (approx. 2 lines)
         32     current_cache = caches[-1]
    ---> 33     grads["dA" + str(L)], grads["dW" + str(L)], grads["db" + str(L)] = linear_backward(sigmoid_backward(dAL, current_cache[1]), current_cache[0])
         34     ### END CODE HERE ###
         35 
